        ...
        <AnimatePresence mode="wait">
          ...
          >
            <ScrollArea className="h-[70vh]">
              <div className="flex flex-col gap-y-2 h-full pt-2 sm:pt-0">
      ...
      <div className="flex items-center justify-between border-b text-sm px-3 py-2 cursor-pointer group">
        <div className="flex items-start gap-x-4">
          ...
          <div>
            ...
            <div className="text-[12px] text-muted-foreground flex flex-col sm:flex-row sm:items-center gap-y-2 sm:gap-y-0 sm:gap-x-2.5">
