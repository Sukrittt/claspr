          ...
          <div className="flex flex-col gap-y-2">
            {!pendingAssignments || pendingAssignments.length === 0 ? (
              ...
              pendingAssignments.map((assignment) => (
                ...
                >
                  <p className="group-hover:underline group-hover:text-neutral-800 dark:group-hover:text-neutral-400 group-hover:text-foreground transition text-sm tracking-tight underline-offset-4">
                    {assignment.title}
                  </p>
