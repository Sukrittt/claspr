...
export const ToggleAnswerSelection: React.FC<ToggleAnswerSelectionProps> = ({
  ...
  return (
    <div
      ...
      className={cn(
        "py-1 px-2 border rounded-full flex items-center gap-x-2 cursor-pointer",
        {
          "opacity-70 cursor-default": alreadyAnswered && !isSelected,
          "hover:bg-neutral-100 transition": isSelected,
        }
      )}
    >
      <CheckCircle2
        className={cn("h-4 w-4 text-gray-200 fill-muted-foreground", {
